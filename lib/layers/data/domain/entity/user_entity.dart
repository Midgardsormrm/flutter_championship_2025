...
import 'package:matule/layers/data/domain/entity/item_entity.dart';
import 'package:matule/layers/data/domain/entity/product_entity.dart';
...
class UserEntity extends Equatable {
  ...
  Map<String, dynamic> toJson() => {
        ...
        'items': this.items!.map((toElement) {
